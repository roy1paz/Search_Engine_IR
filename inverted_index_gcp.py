...
class MultiFileReader:
    ...
    def read(self, locs, n_bytes):
        b = []
        # print(f"open files from gs://{self.bucket_name}/postings_gcp")
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = self.GCSFS.open(f"gs://{self.bucket_name}/postings_gcp/{f_name}","rb")
...
class InvertedIndex:  
    def __init__(self, docs={}, doc_pairs_dict={}, bucket_name=None):
